module.exports = class Init1662114379860 {
  name = 'Init1662114379860'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "pair_hour_data" ("id" character varying NOT NULL, "hour_start_unix" numeric NOT NULL, "reserve0" text NOT NULL, "reserve1" text NOT NULL, "total_supply" text NOT NULL, "reserve_usd" text, "hourly_volume_tolen0" text NOT NULL, "hourly_volume_tolen1" text NOT NULL, "hourly_volume_usd" text NOT NULL, "hourly_txns" integer NOT NULL, "pair_id" character varying NOT NULL, CONSTRAINT "PK_ffc544bb3e72cfd3e48a8b01452" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_cf50c55389e428096a68598ee3" ON "pair_hour_data" ("pair_id") `)
    await db.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "usd_swapped" text, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "liquidity_position_snapshot" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block" integer NOT NULL, "token0_price_usd" text NOT NULL, "token1_price_usd" text NOT NULL, "reserve0" text NOT NULL, "reserve1" text NOT NULL, "reserve_usd" text NOT NULL, "liquidity_token_total_supply" text NOT NULL, "liquidity_token_balance" text NOT NULL, "liquidity_positions_id" character varying NOT NULL, "user_id" character varying NOT NULL, "pair_id" character varying NOT NULL, CONSTRAINT "PK_cd4ed3539266b2439349a9fa791" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4381fd213c7e2ee3c26a6b0dbe" ON "liquidity_position_snapshot" ("liquidity_positions_id") `)
    ...
    await db.query(`CREATE TABLE "mint" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "to" text NOT NULL, "liquidity" text NOT NULL, "sender" text, "amount0" text NOT NULL, "amount1" text NOT NULL, "log_index" integer, "amount_usd" text, "fee_to" text, "fee_liquidity" text, "transaction_id" character varying NOT NULL, "pair_id" character varying NOT NULL, CONSTRAINT "PK_fcaea791104aa41aa11dac29cb2" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "pair" ("id" character varying NOT NULL, "reserve0" text NOT NULL, "reserve1" text NOT NULL, "total_supply" text NOT NULL, "reserve_native" text NOT NULL, "reserve_usd" text NOT NULL, "tracked_reserve_native" text NOT NULL, "token0_price" text NOT NULL, "token1_price" text NOT NULL, "volume_token0" text NOT NULL, "volume_token1" text NOT NULL, "volume_usd" text NOT NULL, "untracked_volume_usd" text NOT NULL, "tx_count" integer NOT NULL, "created_at_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at_block_number" numeric NOT NULL, "liquidity_provider_count" integer NOT NULL, "factory_id" character varying NOT NULL, "token0_id" character varying NOT NULL, "token1_id" character varying NOT NULL, CONSTRAINT "PK_3eaf216329c5c50aedb94fa797e" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_6913e21664a5f83ece1834f9a6" ON "pair" ("factory_id") `)
    ...
    await db.query(`CREATE TABLE "avault_day_data" ("id" character varying NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "daily_volume_native" text NOT NULL, "daily_volume_usd" text NOT NULL, "daily_volume_untracked" text NOT NULL, "total_volume_usd" text NOT NULL, "total_volume_native" text NOT NULL, "total_liquidity_native" text NOT NULL, "total_liquidity_usd" text NOT NULL, "tx_count" integer NOT NULL, CONSTRAINT "PK_9eb37d8f96c83a20166433f752d" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "liquidity_position_snapshot" ADD CONSTRAINT "FK_4381fd213c7e2ee3c26a6b0dbe1" FOREIGN KEY ("liquidity_positions_id") REFERENCES "liquidity_position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "pair" ADD CONSTRAINT "FK_6913e21664a5f83ece1834f9a6a" FOREIGN KEY ("factory_id") REFERENCES "factory"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_4381fd213c7e2ee3c26a6b0dbe"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_6913e21664a5f83ece1834f9a6"`)
    ...
    await db.query(`ALTER TABLE "liquidity_position_snapshot" DROP CONSTRAINT "FK_4381fd213c7e2ee3c26a6b0dbe1"`)
    ...
    await db.query(`ALTER TABLE "pair" DROP CONSTRAINT "FK_6913e21664a5f83ece1834f9a6a"`)
